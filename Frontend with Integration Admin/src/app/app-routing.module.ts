...
const routes: Routes = [
  ...
  { path: 'survey/create/builder', component: SurveyBuilderComponent },
  { path: 'survey/create/response', component: ResponseTemplateComponent },
  { path: 'survey/create/summary', component: SummaryPageComponent },
