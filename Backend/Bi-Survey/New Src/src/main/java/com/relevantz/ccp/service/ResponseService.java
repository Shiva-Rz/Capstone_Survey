...
//	}
	...
	public boolean delete(long responseId) {
		rsRepo.deleteById(responseId);
		return true;
	}

	public List<Responses> getByResponsesDetailId(long responsedetailId) {
	...
	public List<Responses> getAllResponsesDetails() {
	...
	public List<ResponsesDTO> getAllResponses(long surveyId) {
		Iterator<ResponseDetails> reDIt = resDetailRepo.findBySurveyId(surveyId).iterator();
