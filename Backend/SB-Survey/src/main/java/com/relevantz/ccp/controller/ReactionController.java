...
public class ReactionController {
	...
	@GetMapping("/getReactionCountByRegion/{regionId}")
	public List<ReactionDTO> performReactionCountByRegion (@PathVariable("regionId") long regionId) {
		return rnService.getReactionCountByRegion(regionId);
		//return reactionService.getAllReactionDetails();
	}
